...
static void vhost_iommu_set_page_size_mask(IOMMUMemoryRegion *mr,
...
static void vhost_iommu_device_realize(DeviceState *dev, Error **errp)
{
    ...
    pci_setup_iommu(pcibus, vhost_iommu_find_add_as, s);
                                                  ...
                                                  void *data)
{
    ...
    imrc->set_page_size_mask = vhost_iommu_set_page_size_mask;
}
